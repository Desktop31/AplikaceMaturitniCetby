...
-- Schema maturitni_cetba
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `maturitni_cetba` DEFAULT CHARACTER SET utf8 COLLATE utf8_czech_ci ;
USE `maturitni_cetba` ;
...
CREATE TABLE IF NOT EXISTS `maturitni_cetba`.`class` (
  ...
  INDEX `fk_class_teacher1_idx` (`teacher_id_teacher` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `maturitni_cetba`.`student` (
  ...
  INDEX `fk_student_class_idx` (`class_id_class` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `maturitni_cetba`.`book_has_author` (
  `bookList_id_book` INT NOT NULL,
  `author_id_author` INT NOT NULL,
  PRIMARY KEY (`bookList_id_book`, `author_id_author`),
  INDEX `fk_bookList_has_author_author1_idx` (`author_id_author` ASC) VISIBLE,
  INDEX `fk_bookList_has_author_bookList1_idx` (`bookList_id_book` ASC) VISIBLE,
  CONSTRAINT `fk_bookList_has_author_bookList1`
    FOREIGN KEY (`bookList_id_book`)
...
CREATE TABLE IF NOT EXISTS `maturitni_cetba`.`student_has_book` (
  ...
  PRIMARY KEY (`student_id_student`, `book_id_book`),
  INDEX `fk_student_has_bookList_bookList1_idx` (`book_id_book` ASC) VISIBLE,
  INDEX `fk_student_has_bookList_student1_idx` (`student_id_student` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `maturitni_cetba`.`changeRequests`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `maturitni_cetba`.`changeRequests` (
  `id_changeRequests` INT NOT NULL AUTO_INCREMENT,
  ...
  INDEX `fk_changeRequests_teacher1_idx` (`teacher_id_teacher` ASC) VISIBLE,
