...
-- -----------------------------------------------------
-- Schema maturitni_cetba1
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema maturitni_cetba1
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `maturitni_cetba1` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_czech_ci ;
USE `maturitni_cetba1` ;

-- -----------------------------------------------------
-- Table `maturitni_cetba1`.`teacher`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `maturitni_cetba1`.`teacher` (
...
-- -----------------------------------------------------
-- Table `maturitni_cetba1`.`class`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `maturitni_cetba1`.`class` (
  ...
  CONSTRAINT `fk_class_teacher1`
    ...
    REFERENCES `maturitni_cetba1`.`teacher` (`id_teacher`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `maturitni_cetba1`.`student`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `maturitni_cetba1`.`student` (
  ...
  CONSTRAINT `fk_student_class`
    ...
    REFERENCES `maturitni_cetba1`.`class` (`id_class`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);


-- -----------------------------------------------------
-- Table `maturitni_cetba1`.`book`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `maturitni_cetba1`.`book` (
...
-- -----------------------------------------------------
-- Table `maturitni_cetba1`.`author`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `maturitni_cetba1`.`author` (
...
-- -----------------------------------------------------
-- Table `maturitni_cetba1`.`book_has_author`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `maturitni_cetba1`.`book_has_author` (
  ...
  CONSTRAINT `fk_bookList_has_author_bookList1`
    FOREIGN KEY (`book_id`)
    REFERENCES `maturitni_cetba1`.`book` (`id_book`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_bookList_has_author_author1`
    FOREIGN KEY (`author_id`)
    REFERENCES `maturitni_cetba1`.`author` (`id_author`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `maturitni_cetba1`.`student_has_book`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `maturitni_cetba1`.`student_has_book` (
  ...
  CONSTRAINT `fk_student_has_bookList_student1`
    ...
    REFERENCES `maturitni_cetba1`.`student` (`id_student`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `maturitni_cetba1`.`swap_request`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `maturitni_cetba1`.`swap_request` (
